...
# Import the Base from all models
...
target_metadata = CryptoTrackerBase.metadata
...
def run_migrations_offline() -> None:
    ...
    context.configure(
        ...
        version_table_schema=database_config.schema_name,
    )
...
def run_migrations_online() -> None:
    ...
    with connectable.connect() as connection:
        ...
        connection.execute(f"SET search_path TO {database_config.schema_name},public")
