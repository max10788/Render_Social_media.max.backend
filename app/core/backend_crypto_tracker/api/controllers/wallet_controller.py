...
from app.core.backend_crypto_tracker.blockchain.blockchain_specific.ethereum.get_address_transactions import get_address_transactions as get_eth_transactions
from app.core.backend_crypto_tracker.blockchain.blockchain_specific.solana.get_confirmed_signatures_for_address2 import get_confirmed_signatures_for_address2 as get_sol_signatures
from app.core.backend_crypto_tracker.blockchain.blockchain_specific.solana.get_transaction_details import get_transaction_details as get_sol_transaction
from app.core.backend_crypto_tracker.blockchain.blockchain_specific.sui.get_transaction_blocks import get_transaction_blocks as get_sui_transactions
